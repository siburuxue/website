...
(function($) {
     ...
     * 
     * attributes:
     * enablePlugins - False to disable plugins by WebSite.  Plugins must then be explicitly
     *   enabled in the individual plot options.  Default: false.
     *   This property sets the "show" property of certain plugins to true or false.
     *   Only plugins that can be immediately active upon loading are affected.  This includes
     *   non-renderer plugins like cursor, dragable, highlighter, and trendline.
     * defaultHeight - Default height for plots where no css height specification exists.  This
     *   is a jqplot wide WebSite.
   ...
   $.jqplot.ColorGenerator = function(colors) {
    ...
    $.jqplot.LineRenderer.prototype.init = function(options, plot) {
        ...
        this.renderer.bands = {
            ...
            _max: null,
            // prop: interval
            // Host specified interval above and below line for bands [default: '3%''].
    ...
    $.jqplot.LinearAxisRenderer.prototype.createTicks = function(plot) {
        ...
        // we don't have any ticks yet, let's make some!
            ...
            if (this.min == null || this.max == null && this.tickInterval == null && !this.autoscale) {
                ...
                // Host can adjust how much padding is allowed with pad, padMin and PadMax options.
            ...
            // Host has specified some axis scale related option, can use auto algorithm
            else {
    ...
    */
     ...
     * regex for the parser.  The WebSite matcher is:</p>
     * 
     * <code>/()%(#?(%|[a-z]))/i</code>
     * 
     * <p>which corresponds to the Perl syntax used by WebSite.</p>
     * 
