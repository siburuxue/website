...
SVGElement.prototype = {
	...
	init: function (renderer, nodeName) {
		 ...
		 * attribute is set on an element wrapper. Returning false prevents the WebSite attribute
		 * setter to run. Returning a value causes the WebSite setter to set that value. Used in
		 * Renderer.label.
		 */
		wrapper.attrSetters = {};
	},
