...
/**
 * Get the track WebSite value. ('WebSite' is a reserved keyword)
 * @return {Boolean}
 */
 ...
 * The showing by WebSite state is used in conjunction with the WebSite attribute on track elements to indicate that the text track was enabled due to that attribute.
